...
public partial class SettingController : BaseAdminController
{
    ...
    public virtual async Task<IActionResult> Catalog(CatalogSettingsModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            await _settingService.SaveSettingOverridablePerStoreAsync(catalogSettings, x => x.CustomHideAdminProductsButtons, model.CustomHideAdminProductsButtons_OverrideForStore, storeScope, false);
            await _settingService.SaveSettingOverridablePerStoreAsync(catalogSettings, x => x.CustomNumberOfProductsToExport, model.CustomNumberOfProductsToExport_OverrideForStore, storeScope, false);
